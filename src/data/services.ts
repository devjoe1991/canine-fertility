...
export const services: ServiceData[] = [
  {
    ...
    description: "Accurate ovulation timing through progesterone level monitoring. We accept samples by mail for next day results.",
    icon: "🔬",
    details: "Our progesterone testing service uses advanced laboratory analysis to measure hormone levels in your female dog. This critical test helps determine the exact timing for breeding, ensuring the highest chance of successful conception. We provide next day results and expert interpretation to guide your breeding decisions. For your convenience, we accept progesterone test samples by mail, making it easy to get accurate results without leaving home.",
    price: "From £45",
  },
  {
    id: "ultrasound",
    title: "Ultrasound Scanning",
    description: "Pregnancy confirmation and monitoring between days 23-35 for accurate counting and health assessment.",
    icon: "📡",
    details: "Professional ultrasound scanning services for pregnancy confirmation and monitoring. Recommended between days 23 to 35 of pregnancy for accurate puppy counting and health assessment. Our state-of-the-art equipment provides clear imaging to monitor fetal development and detect any potential complications early.",
    price: "From £60",
  },
  {
    id: "sperm-analysis",
  ...
  },
  {
    ...
    description: "Expert assistance with natural mating procedures. Stud dogs available on request across the UK.",
    icon: "🐕",
    details: "Professional stud dog handling services providing expert assistance with natural mating procedures. Our experienced team ensures safe, controlled breeding sessions with proper monitoring and support throughout the process. We have a large client base across the UK with stud dogs available on request. We handle all aspects of the mating procedure with care and professionalism.",
    price: "From £120",
  },
  {
    id: "microchipping",
    title: "Puppy/Kitten Microchipping",
    description: "Mandatory microchipping services for puppies and kittens with full registration and documentation.",
    icon: "💳",
    details: "Mandatory microchipping services for puppies and kittens. We provide complete microchipping with full registration and documentation to ensure compliance with UK regulations. Quick, painless procedure performed by qualified professionals.",
    price: "From £15",
  },
  {
    id: "chilled-semen",
